...
"""
    ...
    chat_parser.add_argument(
        "--provider",
        choices=["auto", "openrouter", "nous", "openai-codex", "qwen-oauth", "copilot-acp", "copilot", "anthropic", "huggingface", "zai", "kimi-coding", "minimax", "minimax-cn", "kilocode"],
        default=None,
    ...
    login_parser.add_argument(
        "--provider",
        choices=["nous", "openai-codex", "qwen-oauth"],
        default=None,
