...
_HAS_MISTRAL = _ilu.find_spec("mistralai") is not None
...
def _transcribe_mistral(file_path: str, model_name: str) -> Dict[str, Any]:
    ...
    if not _HAS_MISTRAL:
        return {"success": False, "transcript": "", "error": "mistralai package not installed"}
    ...
    try:
        ...
        transcript_text = str(getattr(result, "text", result)).strip()
        logger.info(
...
def transcribe_audio(file_path: str, model: Optional[str] = None) -> Dict[str, Any]:
    ...
    return {
        ...
        "error": (
            ...
            "Voxtral Transcribe, or set VOICE_TOOLS_OPENAI_KEY or OPENAI_API_KEY "
