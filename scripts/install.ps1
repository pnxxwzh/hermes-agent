...
#
# Usage:
#   irm https://raw.githubusercontent.com/pnxxwzh/hermes-agent/mem-research/scripts/install.ps1 | iex
#
...
$RepoUrlSsh = "git@github.com:pnxxwzh/hermes-agent.git"
$RepoUrlHttps = "https://github.com/pnxxwzh/hermes-agent.git"
$PythonVersion = "3.11"
$NodeVersion = "22"
...
function Install-Repository {
    ...
    if (Test-Path $InstallDir) {
        ...
        if (-not $cloneSuccess) {
            ...
            try {
                $zipUrl = "https://github.com/pnxxwzh/hermes-agent/archive/refs/heads/$Branch.zip"
...
try {
    ...
    Write-Host "  Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/pnxxwzh/hermes-agent/mem-research/scripts/install.ps1' -OutFile install.ps1" -ForegroundColor Yellow
